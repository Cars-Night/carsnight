...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cars Night" },
      { name: "description", content: "CarsNight is a social network for car enthusiasts, offering a platform to share rides and connect with a global community." },
      { name: "author", content: "CarsNight" },
      ...
      { name: "twitter:description", content: "CarsNight is a social network for car enthusiasts, offering a platform to share rides and connect with a global community." },
